...
namespace ToDoApp_WPF.Operations
{
    static class ApiOperations
    {
        ...
        public static void RegisterUser(string email, string password, string confirmPassword, Window registerForm)
        {
        ...
        public static void GetTasks()
        {
            ...
            using (HttpClient client = new HttpClient())
            {
                ...
                string resultJSON = response.Content.ReadAsStringAsync().Result;
                mainWindow.ListOfTasks.ItemsSource = JsonConvert.DeserializeObject<List<Task>>(resultJSON).ToList();
            }
        }

        public static void CreateTask(string header, string description, DateTime? dateOfTask, int? directoryId, Window registerForm)
        {
        ...
        public static void UpdateTask(int id, string header, string description, DateTime? dateOfTask, bool isDone)
        {
        ...
        public static void GetTasksInDirectory(int directoryId)
        {
            MainWindow mainWindow = Application.Current.Windows.OfType<MainWindow>().First();
            using (HttpClient client = new HttpClient())
            {
